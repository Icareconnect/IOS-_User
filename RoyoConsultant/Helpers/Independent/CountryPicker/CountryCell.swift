...
class CountryCell: UITableViewCell {
    ...
    func setup() {
        ...
        nameLabel = UILabel()
        nameLabel?.textColor = ColorAsset.txtMoreDark.color
        nameLabel?.font = Fonts.CamptonBook.ofSize(16)
        ...
        extensionLabel?.textColor = ColorAsset.txtLightGrey.color
        extensionLabel?.font = Fonts.CamptonLight.ofSize(16)
