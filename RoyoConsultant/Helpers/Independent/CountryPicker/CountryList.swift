...
public class CountryList: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchResultsUpdating {
    ...
    override public func viewDidLoad() {
        ...
        self.view.backgroundColor = ColorAsset.backgroundColor.color
        
        tableView = UITableView(frame: view.frame)
        tableView.register(CountryCell.self, forCellReuseIdentifier: "Cell")
        tableView.tableFooterView = UIView()
        tableView.tableFooterView?.backgroundColor = ColorAsset.backgroundColor.color
        tableView.dataSource = self
        tableView.separatorInset.left = 0
        tableView.delegate = self
        tableView.backgroundColor = ColorAsset.backgroundColor.color
    ...
    func setUpSearchBar() {
        ...
        self.searchController?.searchBar.backgroundColor = ColorAsset.backgroundColor.color
